...
export default function StoryIntelligenceCard({
  ...
  return (
    <motion.div
      ...
      className="rounded-2xl border border-[#fbd509]/30 bg-[#fbd509]/[0.04] p-5 dark:border-[#fbd509]/20"
    >
      ...
      {timeline.length > 1 && (
        <div className="mt-4 border-l-2 border-stone-200 pl-3 dark:border-white/10">
          {timeline.map((a) => (
            ...
            >
              <span className="absolute top-1 -left-[17px] h-2 w-2 rounded-full bg-[#fbd509]" />
